...
public class CustomTextPartitioningHandler : IPipelineStepHandler
{
            ...
            foreach (KeyValuePair<string, DataPipeline.GeneratedFileDetails> generatedFile in uploadedFile.GeneratedFiles)
            {
                ...
                switch (file.MimeType)
                {
                    case MimeTypes.PlainText:
                    {
                        ...
                        // TODO:if the block which are already partitioned in the step previous "Extract" fits well the chunk size, we don't need to partition it

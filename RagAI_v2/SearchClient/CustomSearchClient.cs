...
#pragma warning disable KMEXP05


/// <summary>
/// Client de recherche personnalisé pour interagir avec la base de données mémoire.
/// </summary>
public sealed class CustomSearchClient : ISearchClient
{
    private readonly IMemoryDb _memoryDb;
    private readonly ITextGenerator _textGenerator;
    private readonly SearchClientConfig _config;
    private readonly ILogger<CustomSearchClient> _log;
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        this._log = (loggerFactory ?? DefaultLogger.Factory).CreateLogger<CustomSearchClient>();
...
#pragma warning restore CA2254
        ...
        IAsyncEnumerable<(MemoryRecord, double)> matches = string.IsNullOrEmpty(query)
            ...
            : this._memoryDb.GetSimilarListAsync(index, text: query, filters, minRelevance, limit, true, cancellationToken);

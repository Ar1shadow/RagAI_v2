...
using PostgresConfig = Microsoft.KernelMemory.PostgresConfig;
...
public static partial class KernelMemoryBuilderExtensions
{
    ...
    public static IKernelMemoryBuilder WithCustomPostgresMemoryDb(this IKernelMemoryBuilder builder, PostgresConfig config)
    {

...
internal static class ChatHistoryReducerExtensions
{
    ...
    /// the presence of the specified metadata key.Or the index of summary which exceeds the maxSummaryCount.
    /// </summary>
    /// <param name="chatHistory">The source history</param>
    /// <param name="summaryKey">The metadata key that identifies a summary message.</param>
    /// <param name="maxSummaryCount">The max number of summaries in a single chat history</param>>

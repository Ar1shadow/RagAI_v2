...
public class PostgresConfig
{
    ...
    /// <summary>
    /// Mandatory prefix to add to tables created by RagAI.
    /// This is used to distinguish Rag tables from others in the same schema.
    /// </summary>
    /// <remarks>Default value is set to "rag-" but can be override when creating a config.</remarks>
